...
export class UpdateUserComponent implements OnInit, OnDestroy {
  ...
  onSubmit() {
    ...
    if (this.updateForm.valid) {
      ...
      updatedUserData.id = Number(updatedUserData.id);
      ...
      formData.append('Email', updatedUserData.emailAddress);
      formData.append('Contact', updatedUserData.phoneNumber);

      // Optional if your API accepts it
      if (updatedUserData.userType != null) {
        formData.append('UserType', updatedUserData.userType);
      }
